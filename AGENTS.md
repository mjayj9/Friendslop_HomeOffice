...
- 최신 요구: [V5 통합 명세](homeoffice/docs/v5/master-spec-ko.md). 현재 상태: [TASK_STATE.md](TASK_STATE.md).
...
- 명세의 N01–N34 및 T01–T48을 추적한다. V4 Q01–Q32는 보존할 회귀 기준이다. 코드 사실, 과거 기록, 자동 fixture, 이번 실제 UI, 실제 사람 검증을 구분한다.
