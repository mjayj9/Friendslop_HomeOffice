...
window.Homeoffice={
 performance_sample:json=>{perfSample=JSON.parse(json)},ready(){loaded=true;$('loading').textContent='공간 준비 완료 · 천천히 들어오세요';for(const n of ['host','solo','join'])$(n).disabled=false;console.info('GODOT_WEB_READY')},
